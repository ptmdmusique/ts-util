export const holdingData = {
  accounts: [
    {
      account_id: "eGaD3vWobNsjQJLpv4WgfGKGwjykXmIMJ4vqb",
      balances: {
        available: 100,
        current: 110,
    ...
    {
      account_id: "QdVA6JDK9bS5Zvzm93WMSaPaebqrjVCkZ5PNM",
      balances: {
        available: 200,
        current: 210,
        iso_currency_code: "USD",
    ...
    {
      account_id: "ZZgA6qWNdlHKWvLG9eb7SxKxjX4Pgat8P6aoL",
      balances: {
        available: null,
        current: 1000,
        iso_currency_code: "USD",
    ...
    {
      account_id: "MzwV67DAEWH5o31GMmLlSJqJWDPVaziDNJXjv",
      balances: {
        available: null,
        current: 410,
        iso_currency_code: "USD",
    ...
    {
      account_id: "1qyB5lEGPXfqmL1WJ9DZSmpmo1bvrxHQN89n1",
      balances: {
        available: 43200,
        current: 43200,
        iso_currency_code: "USD",
    ...
    {
      account_id: "Lrjw6VDWgEH54BVjme1QSANAo9wZd1HLqX6Am",
      balances: {
        available: null,
        current: 320.76,
        iso_currency_code: "USD",
    ...
    {
      account_id: "pyLmZ5nzaoCz6AlLWjxpurKrw9P856uDbZl76",
      balances: {
        available: null,
        current: 23631.9805,
        iso_currency_code: "USD",
    ...
    {
      account_id: "oGXoQ5nrxpsrDmxZ6e3XiMBMQJRqN5fX1dQJ4",
      balances: {
        available: null,
        current: 65262,
        iso_currency_code: "USD",
    ...
    {
      account_id: "gGA6dbW8vjserAW8PZ9xI9Z9XEaMmPHlPxNel",
      balances: {
        available: null,
        current: 56302.06,
        iso_currency_code: "USD",
  ...
  item: {
    available_products: ["assets", "balance", "identity", "income"],
    billed_products: ["auth", "investments", "transactions"],
    consent_expiration_time: null,
    error: null,
    institution_id: "ins_54",
    item_id: "Lrjw6VDWgEH54BVjme1QSANAA97va7SLvoLx8",
    update_type: "background",
    webhook: "",
  },
  request_id: "z0twHw9ih3s2J7L",
  securities: [
    {
      close_price: 0.011,
    ...
    },
    {
      ...
      proxy_security_id: "PDRMBVM8r3t5BAAqaKnmFPolGqlg8dtEGxywZ",
      security_id: "JDdP7XPMklt5vwPmDN45t3KAoWAPmjtpaW7DP",
      sedol: null,
      ticker_symbol: "MIPTX",
      type: "mutual fund",
    ...
    },
    {
      ...
      sedol: null,
      ticker_symbol: "PZ8XP9000",
      type: null,
      unofficial_currency_code: null,
    },
    {
      close_price: 36.14,
      close_price_as_of: "2021-03-22",
      cusip: "577130107",
      institution_id: null,
      institution_security_id: null,
      is_cash_equivalent: false,
      isin: "US5771301075",
      iso_currency_code: "USD",
      name: "Matthews Pacific Tiger Investor",
      proxy_security_id: null,
      security_id: "PDRMBVM8r3t5BAAqaKnmFPolGqlg8dtEGxywZ",
      sedol: "2529279",
      ticker_symbol: "MAPTX",
      type: "mutual fund",
      unofficial_currency_code: null,
